...
{
    public partial class fmrCase2 : Form
    {
        public fmrCase2()
        {
            InitializeComponent();
        ...
        private void fmrCase2_MouseMove(object sender, MouseEventArgs e)
        {
        ...
        private void preOrdenToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Preorden.DrawString("15", Font, Brushes.Purple, 100, 400);
            Pen myNodo2 = new Pen(Color.Green, 1);
            Preorden.DrawEllipse(myNodo2, 130, 390, 35, 35);
            Preorden.DrawString("6", Font, Brushes.Purple, 140, 400);
        ...
        private void inOrdenToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Inorden.DrawString("1", Font, Brushes.Purple, 100, 460);
            Pen myNodo2 = new Pen(Color.Green, 1);
            Inorden.DrawEllipse(myNodo2, 130, 450, 35, 35);
            Inorden.DrawString("3", Font, Brushes.Purple, 140, 460);
            Pen myNodo3 = new Pen(Color.Green, 1);
            Inorden.DrawEllipse(myNodo2, 170, 450, 35, 35);
            Inorden.DrawString("4", Font, Brushes.Purple, 180, 460);
            Pen myNodo4 = new Pen(Color.Green, 1);
            ...
            Inorden.DrawString("9", Font, Brushes.Purple, 300, 460);
            Pen myNodo7 = new Pen(Color.Green, 1);
            Inorden.DrawEllipse(myNodo2, 330, 450, 35, 35);
            Inorden.DrawString("12", Font, Brushes.Purple, 340, 460);
            Pen myNodo8 = new Pen(Color.Green, 1);
            Inorden.DrawEllipse(myNodo1, 370, 450, 35, 35);
            Inorden.DrawString("15", Font, Brushes.Purple, 380, 460);
            Pen myNodo9 = new Pen(Color.Green, 1);
            Inorden.DrawEllipse(myNodo2, 410, 450, 35, 35);
            Inorden.DrawString("17", Font, Brushes.Purple, 420, 460);
            Pen myNodo10 = new Pen(Color.Green, 1);
            Inorden.DrawEllipse(myNodo2, 450, 450, 35, 35);
            Inorden.DrawString("18", Font, Brushes.Purple, 460, 460);
            Pen myNodo11 = new Pen(Color.Green, 1);
            Inorden.DrawEllipse(myNodo2, 490, 450, 35, 35);
            Inorden.DrawString("20", Font, Brushes.Purple, 500, 460);
            Pen myNodo12 = new Pen(Color.Green, 1);
            Inorden.DrawEllipse(myNodo2, 530, 450, 35, 35);
            Inorden.DrawString("24", Font, Brushes.Purple, 540, 460);
        }
        ...
        private void postOrdenToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Postorden.DrawString("1", Font, Brushes.Purple, 100, 520);
            Pen myNodo2 = new Pen(Color.Green, 1);
            Postorden.DrawEllipse(myNodo2, 130, 510, 35, 35);
            Postorden.DrawString("4", Font, Brushes.Purple, 140, 520);
            Pen myNodo3 = new Pen(Color.Green, 1);
            Postorden.DrawEllipse(myNodo2, 170, 510, 35, 35);
            Postorden.DrawString("3", Font, Brushes.Purple, 180, 520);
            Pen myNodo4 = new Pen(Color.Green, 1);
            Postorden.DrawEllipse(myNodo2, 210, 510, 35, 35);
            Postorden.DrawString("7", Font, Brushes.Purple, 220, 520);
            Pen myNodo5 = new Pen(Color.Green, 1);
            Postorden.DrawEllipse(myNodo2, 250, 510, 35, 35);
            Postorden.DrawString("12", Font, Brushes.Purple, 260, 520);
            Pen myNodo6 = new Pen(Color.Green, 1);
            Postorden.DrawEllipse(myNodo2, 290, 510, 35, 35);
            Postorden.DrawString("9", Font, Brushes.Purple, 300, 520);
            Pen myNodo7 = new Pen(Color.Green, 1);
            Postorden.DrawEllipse(myNodo2, 330, 510, 35, 35);
            Postorden.DrawString("6", Font, Brushes.Purple, 340, 520);
            Pen myNodo8 = new Pen(Color.Green, 1);
            Postorden.DrawEllipse(myNodo1, 370, 510, 35, 35);
            Postorden.DrawString("17", Font, Brushes.Purple, 380, 520);
            Pen myNodo9 = new Pen(Color.Green, 1);
            Postorden.DrawEllipse(myNodo2, 410, 510, 35, 35);
            Postorden.DrawString("18", Font, Brushes.Purple, 420, 520);
            Pen myNodo10 = new Pen(Color.Green, 1);
            Postorden.DrawEllipse(myNodo2, 450, 510, 35, 35);
            Postorden.DrawString("24", Font, Brushes.Purple, 460, 520);
            Pen myNodo11 = new Pen(Color.Green, 1);
            ...
            Postorden.DrawString("15", Font, Brushes.Purple, 540, 520);
        }
        ...
        private void graficaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            nodo.DrawString("15", Font, Brushes.Purple, 330, 40);
            ...
            Pen myLinea4 = new Pen(Color.Orange, 2); nodo.DrawLine(myLinea4, 220, 110, 265, 140);
            Pen myLinea5 = new Pen(Color.Orange, 2); nodo.DrawLine(myLinea5, 145, 135, 220, 100);
            Pen myLinea6 = new Pen(Color.Orange, 2); nodo.DrawLine(myLinea6, 410, 140, 445, 110);

            Pen myLinea7 = new Pen(Color.Orange, 2); nodo.DrawLine(myLinea7, 125, 155, 90, 190);
            Pen myLinea8 = new Pen(Color.Orange, 2); nodo.DrawLine(myLinea8, 145, 160, 182, 194);
            Pen myLinea9 = new Pen(Color.Orange, 2); nodo.DrawLine(myLinea9, 275, 160, 245, 190);
            Pen myLinea10 = new Pen(Color.Orange, 2); nodo.DrawLine(myLinea10, 286, 160, 320, 190);
            Pen myLinea11 = new Pen(Color.Orange, 2); nodo.DrawLine(myLinea11, 400, 160, 377, 190);

            //Nodos del subarbol izquiedo
            nodo.FillEllipse(Brushes.Cyan, 200, 80, 35, 35);
            nodo.DrawString("6", Font, Brushes.Purple, 210, 90);
            Pen myNodo1 = new Pen(Color.Orange, 3);
            nodo.DrawEllipse(myNodo1, 200, 80, 35, 35);

            nodo.FillEllipse(Brushes.Cyan, 120, 130, 35, 35);
            nodo.DrawString("3", Font, Brushes.Purple, 130, 140);
            Pen myNodo2 = new Pen(Color.Orange, 3);
            nodo.DrawEllipse(myNodo2, 120, 130, 35, 35);

            nodo.FillEllipse(Brushes.Cyan, 260, 130, 35, 35);
            nodo.DrawString("9", Font, Brushes.Purple, 270, 140);
            Pen myNodo3 = new Pen(Color.Orange, 3);
            nodo.DrawEllipse(myNodo3, 260, 130, 35, 35);

            nodo.FillEllipse(Brushes.Cyan, 222, 185, 35, 35);
            nodo.DrawString("7", Font, Brushes.Purple, 232, 195);
            Pen myNodo8 = new Pen(Color.Orange, 3);
            nodo.DrawEllipse(myNodo8, 222, 185, 35, 35);

            nodo.FillEllipse(Brushes.Cyan, 175, 185, 35, 35);
            nodo.DrawString("4", Font, Brushes.Purple, 185, 195);
            Pen myNodo9 = new Pen(Color.Orange, 3);
            nodo.DrawEllipse(myNodo9, 175, 185, 35, 35);

            nodo.FillEllipse(Brushes.Cyan, 310, 185, 35, 35);
            nodo.DrawString("12", Font, Brushes.Purple, 320, 195);
            Pen myNodo10 = new Pen(Color.Orange, 3);
            nodo.DrawEllipse(myNodo10, 310, 185, 35, 35);

            nodo.FillEllipse(Brushes.Cyan, 68, 185, 35, 35);
            nodo.DrawString("1", Font, Brushes.Purple, 78, 195);
            Pen myNodo11 = new Pen(Color.Orange, 3);
            nodo.DrawEllipse(myNodo11, 68, 185, 35, 35);

            //Nodos del subarbol derecho
            nodo.FillEllipse(Brushes.Cyan, 440, 80, 35, 35);
            nodo.DrawString("20", Font, Brushes.Purple, 450, 90);
            Pen myNodo4 = new Pen(Color.Orange, 3);
            nodo.DrawEllipse(myNodo4, 440, 80, 35, 35);

            nodo.FillEllipse(Brushes.Cyan, 500, 130, 35, 35);
            nodo.DrawString("24", Font, Brushes.Purple, 510, 140);
            Pen myNodo5 = new Pen(Color.Orange, 3);
            nodo.DrawEllipse(myNodo5, 500, 130, 35, 35);

            nodo.FillEllipse(Brushes.Cyan, 380, 130, 35, 35);
            nodo.DrawString("18", Font, Brushes.Purple, 390, 140);
            Pen myNodo6 = new Pen(Color.Orange, 3);
            nodo.DrawEllipse(myNodo6, 380, 130, 35, 35);

            nodo.FillEllipse(Brushes.Cyan, 355, 185, 35, 35);
            nodo.DrawString("17", Font, Brushes.Purple, 365, 195);
            Pen myNodo12 = new Pen(Color.Orange, 3);
            nodo.DrawEllipse(myNodo12, 355, 185, 35, 35);
        }
    }
}
